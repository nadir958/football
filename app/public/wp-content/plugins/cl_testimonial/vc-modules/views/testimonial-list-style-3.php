...
<div id="cl-testimonial" class="cl-testimonial-list cl-testimoniallist3 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>">
		   		<div class="clt-container">
					...
					<div class="testimonial-item">
					    <div class="testimonial-content"<?php echo $dsignation_bg_color; ?>>
					        <div class="image-testimonial <?php echo esc_attr($no_author); ?>">
					            <?php if(!empty($post_img_url)):?><img src="<?php echo esc_url($post_img_url); ?>" alt="<?php echo esc_attr($post_title); ?>"><?php endif; ?>
