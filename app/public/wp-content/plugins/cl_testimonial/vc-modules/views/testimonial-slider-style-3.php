...
<div id="cl-testimonial" class="cl-testimonial slider3 owl-carousel testi-carousels cl-testimonial3 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>" data-carousel-options="<?php echo esc_attr( $owl_data ); ?>">
			<?php	
			...
			?>		
					...
					<div class="testimonial-item">
						<div class="cl-author image-testimonial <?php echo esc_attr($no_author); ?>">
							<div class="testimonial-content" <?php echo $dsignation_bg_color; ?>>
								<p class="description" <?php echo $content_color; ?>>
									<i class="<?php echo esc_attr($icon_fontawesome);?>"<?php echo $quote_color; ?>></i> <?php echo esc_attr($post_content);?>
								</p>
