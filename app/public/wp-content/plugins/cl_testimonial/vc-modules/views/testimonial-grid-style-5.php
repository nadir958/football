...
<div id="cl-testimonial" class="cl-testimonial5 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>">
		   		<div class="clt-container">                
					...
					<?php	
						...
						$dsignation_bg_color = ($dsignation_bg_color) ? ' style="background-color: '.$dsignation_bg_color.';padding: 20px;"' : '';
					...
					<div class="testimonial-item cl-sm-6 cl-col-<?php echo $grid_col ?>">
		...
		<div class="testimonial-item">
		    ...
		    <div class="cl-author image-testimonial">					    	
		        <div class="testimonial-content"<?php echo $dsignation_bg_color; ?>>
		            ...
		            <div class="image"><?php if ($imgSrc) { echo $imageClass; } ?></div>
