	...
	if($dsignation_bg_color) : ?>
		...
		<style type="text/css">
			.slider4 .testimonial-content p {
			    border-color: <?php echo esc_attr($dsignation_bg_color); ?>;
			    box-shadow: 0 7px rgba(0, 0, 0, 0.1), 0 5px <?php echo esc_attr($dsignation_bg_color); ?>;
			}
		</style>
		
	<?php endif; ?>

<div id="cl-testimonial" class="cl-testimonial slider4 owl-carousel testi-carousels cl-testimonial2 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>" data-carousel-options="<?php echo esc_attr( $owl_data ); ?>">
			<?php	
