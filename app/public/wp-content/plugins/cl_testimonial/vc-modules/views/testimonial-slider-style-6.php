...
<div id="cl-testimonial" class="slider6 type-slider owl-carousel testi-carousels cl-testimonial3 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>" data-carousel-options="<?php echo esc_attr( $owl_data ); ?>">
					<?php	
					...
					<div class="testimonial-item">
						...
						<div class="single-testimonial" <?php echo $dsignation_bg_color; ?>>
						    <div class="testimonial-content testimonial-left <?php echo esc_attr($no_author); ?>">
