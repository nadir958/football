...
<div id="cl-testimonial" class="cl-testimonial cl-testimonial3 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>">
		   		<div class="clt-container">                
					...
					<div class="testimonial-item cl-col-<?php echo $grid_col ?>">
						...
						<div class="single-testimonial"<?php echo $dsignation_bg_color; ?>>
						    <div class="testimonial-content testimonial-left">
