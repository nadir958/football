...
<div id="cl-testimonial" class="cl-testimonial type-slider owl-carousel testi-carousels cl-testimonial2 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>" data-carousel-options="<?php echo esc_attr( $owl_data ); ?>">
			<?php	
