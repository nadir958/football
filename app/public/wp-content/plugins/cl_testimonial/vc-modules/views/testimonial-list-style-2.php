...
<div id="cl-testimonial" class="cl-testimonial-list2 <?php echo esc_attr($css_class); echo esc_attr($css_class_custom);?>">
		   		<div class="clt-container">                
					...
					<?php	
						...
						$dsignation_bg_color = ($dsignation_bg_color) ? ' style="padding: 20px;background-color: '.$dsignation_bg_color.';"' : '';
					...
					<li class="testimonial-item">
					    <div class="testimonial-content <?php echo esc_attr($no_author); ?>"<?php echo $dsignation_bg_color; ?>>
					        <div class="cl-row clearfix">
					        	<?php if(!empty($post_img_url)):?>
						            <div class="cl-col-2">
						                <div class="image-testimonial2"><img src="<?php echo esc_url($post_img_url); ?>" alt="<?php echo esc_attr($post_title); ?>"></div>
						            </div>
					            <?php endif; ?>
			...
			<li class="testimonial-item">
			    <div class="testimonial-content"<?php echo $dsignation_bg_color; ?>>
			        <div class="cl-row clearfix">
			            ...
			            <div class="cl-col-2">
			                <div class="image-testimonial2"><?php if ($imgSrc) { echo $imageClass; } ?></div>
			            </div>
