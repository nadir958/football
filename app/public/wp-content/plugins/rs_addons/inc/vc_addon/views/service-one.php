<?php 
	...
	$html = '<div class="rs-services"><div class="service-inner services-style-8 services-'.$align.' '.$css_class.' '.$css_class_custom.'">
				<div class="services-wrap"> 
			        <div class="services-item">
						...
						<div class="services-desc"  '.$desc_bg.'>	
							<h3 class="services-title services-title2" style="'.$title_spacing.'"><a data-onhovercolor="'.$title_hovercolor.'" data-onleavecolor="'.$title_color.'" '. $attributes.' style="'.$title_css.'">'.$title.'</a></h3>		
