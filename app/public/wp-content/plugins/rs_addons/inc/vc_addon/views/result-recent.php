<div class="today-match-teams text-center <?php echo $css_class;?> <?php echo $css_class_custom;?>">
       		...
       		<a href="<?php echo get_the_permalink(); ?>">
	       		<div class="result-item">
	       			<div class="title-date">
	       				<span class="date" <?php echo wp_kses_post($desc_color); ?> ><?php echo esc_html( $match_date );?></span>
	       			</div>
	       			<div class="today-score">
	       				...
	       				<div class="today-final-score" <?php echo wp_kses_post($desc_color); ?>>
	       					...
	       					<h4 <?php echo wp_kses_post($desc_color); ?>><?php esc_html_e('final score', 'rsaddon'); ?></h4>
	       				</div>
	       				<div class="today-match-team" <?php echo wp_kses_post($desc_color); ?>>
