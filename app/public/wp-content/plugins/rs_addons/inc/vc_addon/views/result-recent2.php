<div class="today-match-teams result-slider-styles  <?php echo $css_class;?> <?php echo $css_class_custom;?>">
				...
				'tax_query' => array(
	       		...
	       		<a href="<?php echo esc_html($links); ?>">
	       			<div class="full-result result-item" style="background-image: url(<?php echo $imgSrc; ?>); background-color: <?php echo $item_bg; ?>">
	       				<div class="title-head">
	       					<span class="vanues" <?php echo $title_color; ?>><?php echo esc_html($vanue);?></span>							
