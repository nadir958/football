<?php
    ...
    */
    global $khelo_option;
    $sticky      = !empty($khelo_option['off_sticky']) ? $khelo_option['off_sticky'] : ''; 
                    ...
                    <div class="col-cell menu-responsive">  
                        ...
                        if($rs_show_quote != 'hide'){
                            if(!empty($khelo_option['quote'])){?>
                                <div class="btn_quote"><a href="<?php echo esc_url($khelo_option['quote_link']); ?>" class="quote-button"><?php  echo esc_html($khelo_option['quote']); ?></a>
                                </div>
                        <?php } }
